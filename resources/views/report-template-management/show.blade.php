...
@section('content')
    ...
    {{-- Informasi Dasar --}}
    @include('report-template-management.partials.template-info', [
    ...
    <div class="rounded-xl bg-white shadow-sm ring-1 ring-gray-100">
        ...
        >
            ...
            <div x-show="open" x-cloak class="border-t border-gray-100 bg-gray-50 px-6 py-4">
                @include('report-template-management.partials.section-form', [
        ...
        <div class="divide-y divide-gray-100">
            @forelse ($reportTemplate->sections as $index => $section)
                @include('report-template-management.partials.section-card', [
                    'reportTemplate'     => $reportTemplate,
                    'section'            => $section,
                    'index'              => $index,
